...
class demo_loop_lora(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, M=32, N=1, T_bch=100, T_g=100, T_p=500, T_s=100, bs_slots=range(4), cp_ratio=0.25, list_sensor=["A","B"], lora_bw=250e3, lora_cr=4, lora_crc=True, lora_sf=7, power_tresh_detect=-8):
        ...
        self.settings = Qt.QSettings("GNU Radio", "demo_loop_lora")
        ...
        self.msg_connect((self.blocks_socket_pdu_0_0, 'pdus'), (self.hier_sensor_lora_0, 'DL'))
        self.msg_connect((self.blocks_socket_pdu_0_0, 'pdus'), (self.hier_sensor_lora_0_0, 'DL'))
        self.msg_connect((self.hier_bs_lora_0, 'BCH'), (self.blocks_socket_pdu_0, 'pdus'))
        self.msg_connect((self.hier_bs_lora_0, 'DL'), (self.blocks_socket_pdu_0, 'pdus'))
        self.msg_connect((self.hier_bs_lora_0, 'DLCCH'), (self.hier_sensor_lora_0, 'DLCCH'))
        self.msg_connect((self.hier_bs_lora_0, 'DLCCH'), (self.hier_sensor_lora_0_0, 'DLCCH'))
        self.msg_connect((self.hier_bs_lora_0, 'feedback'), (self.zeromq_pub_msg_sink_0_0, 'in'))
        self.msg_connect((self.hier_sensor_lora_0, 'ULCCH'), (self.hier_bs_lora_0, 'ULCCH'))
        self.msg_connect((self.hier_sensor_lora_0, 'feedback'), (self.zeromq_pub_msg_sink_0, 'in'))
        self.msg_connect((self.hier_sensor_lora_0_0, 'ULCCH'), (self.hier_bs_lora_0, 'ULCCH'))
    ...
    def set_power_tresh_detect(self, power_tresh_detect):
        self.power_tresh_detect = power_tresh_detect
        self.hier_bs_lora_0.set_power_tresh_detection(self.power_tresh_detect)
...
def main(top_block_cls=demo_loop_lora, options=None):
    if options is None:
