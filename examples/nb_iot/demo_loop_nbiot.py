...
from hier_bs_nbiot import hier_bs_nbiot  # grc-generated hier_block
...
class demo_loop_nbiot(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, M=32, N=1, T_bch=100, T_g=100, T_p=500, T_s=50, bs_slots=range(4), cp_ratio=0.25, list_sensor=["A","B"], lora_bw=250e3, lora_cr=4, lora_crc=True, lora_sf=7, power_tresh_detect=3):
        ...
        self.settings = Qt.QSettings("GNU Radio", "demo_loop_nbiot")
        ...
        self.hier_sensor_nbiot_0_0 = hier_sensor_nbiot(
            M=M,
            N=N,
            T_bch=T_bch,
            T_bch_0=10,
        ...
        self.msg_connect((self.blocks_socket_pdu_0_0, 'pdus'), (self.hier_sensor_nbiot_0, 'DL'))
        self.msg_connect((self.blocks_socket_pdu_0_0, 'pdus'), (self.hier_sensor_nbiot_0_0, 'DL'))
        self.msg_connect((self.hier_bs_nbiot_0, 'BCH'), (self.blocks_socket_pdu_0, 'pdus'))
        self.msg_connect((self.hier_bs_nbiot_0, 'DL'), (self.blocks_socket_pdu_0, 'pdus'))
        self.msg_connect((self.hier_bs_nbiot_0, 'DLCCH'), (self.hier_sensor_nbiot_0, 'DLCCH'))
        self.msg_connect((self.hier_bs_nbiot_0, 'DLCCH'), (self.hier_sensor_nbiot_0_0, 'DLCCH'))
        self.msg_connect((self.hier_bs_nbiot_0, 'feedback'), (self.zeromq_pub_msg_sink_0_0, 'in'))
        self.msg_connect((self.hier_sensor_nbiot_0, 'ULCCH'), (self.hier_bs_nbiot_0, 'ULCCH'))
        self.msg_connect((self.hier_sensor_nbiot_0, 'feedback'), (self.zeromq_pub_msg_sink_0, 'in'))
        self.msg_connect((self.hier_sensor_nbiot_0_0, 'ULCCH'), (self.hier_bs_nbiot_0, 'ULCCH'))
        self.msg_connect((self.hier_sensor_nbiot_0_0, 'feedback'), (self.zeromq_pub_msg_sink_0, 'in'))
    ...
    def set_M(self, M):
        self.M = M
        self.hier_sensor_nbiot_0_0.set_M(self.M)
        self.hier_sensor_nbiot_0.set_M(self.M)
        self.hier_bs_nbiot_0.set_M(self.M)
    ...
    def set_N(self, N):
        self.N = N
        self.hier_sensor_nbiot_0_0.set_N(self.N)
        self.hier_sensor_nbiot_0.set_N(self.N)
        self.hier_bs_nbiot_0.set_N(self.N)
    ...
    def set_T_bch(self, T_bch):
        self.T_bch = T_bch
        self.hier_sensor_nbiot_0_0.set_T_bch(self.T_bch)
        self.hier_sensor_nbiot_0.set_T_bch(self.T_bch)
        self.hier_bs_nbiot_0.set_T_bch(self.T_bch)
    ...
    def set_T_g(self, T_g):
        self.T_g = T_g
        self.hier_sensor_nbiot_0_0.set_T_g(self.T_g)
        self.hier_sensor_nbiot_0.set_T_g(self.T_g)
        self.hier_bs_nbiot_0.set_T_g(self.T_g)
        self.set_frame_len((self.T_bch+len(self.bs_slots)*(self.T_s+self.T_g)+self.T_p)/float(1000))
    ...
    def set_T_p(self, T_p):
        self.T_p = T_p
        self.hier_sensor_nbiot_0_0.set_T_p(self.T_p)
        self.hier_sensor_nbiot_0.set_T_p(self.T_p)
        self.hier_bs_nbiot_0.set_T_p(self.T_p)
        self.set_frame_len((self.T_bch+len(self.bs_slots)*(self.T_s+self.T_g)+self.T_p)/float(1000))
    ...
    def set_T_s(self, T_s):
        self.T_s = T_s
        self.hier_sensor_nbiot_0_0.set_T_s(self.T_s)
        self.hier_sensor_nbiot_0.set_T_s(self.T_s)
        self.hier_bs_nbiot_0.set_T_s(self.T_s)
        self.set_frame_len((self.T_bch+len(self.bs_slots)*(self.T_s+self.T_g)+self.T_p)/float(1000))
    ...
    def set_bs_slots(self, bs_slots):
        self.bs_slots = bs_slots
        self.hier_sensor_nbiot_0_0.set_bs_slots(self.bs_slots)
        self.hier_sensor_nbiot_0.set_bs_slots(self.bs_slots)
        self.hier_bs_nbiot_0.set_bs_slots(self.bs_slots)
        self.set_frame_len((self.T_bch+len(self.bs_slots)*(self.T_s+self.T_g)+self.T_p)/float(1000))
    ...
    def set_list_sensor(self, list_sensor):
        self.list_sensor = list_sensor
        self.hier_sensor_nbiot_0_0.set_id_0(self.list_sensor[1])
        self.hier_sensor_nbiot_0.set_id_0(self.list_sensor[0])
        self.hier_bs_nbiot_0.set_list_sensor(self.list_sensor)
    ...
    def set_power_tresh_detect(self, power_tresh_detect):
        self.power_tresh_detect = power_tresh_detect
        self.hier_bs_nbiot_0.set_power_tresh_detection(self.power_tresh_detect)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.hier_sensor_nbiot_0_0.set_samp_rate(self.samp_rate)
        self.hier_sensor_nbiot_0.set_samp_rate(self.samp_rate)
        self.hier_bs_nbiot_0.set_samp_rate(self.samp_rate)
    ...
    def set_debug_log(self, debug_log):
        ...
        self.hier_sensor_nbiot_0_0.set_debug_log(self.debug_log)
        self.hier_sensor_nbiot_0_0.set_log(self.debug_log)
        self.hier_sensor_nbiot_0.set_debug_log(self.debug_log)
        self.hier_sensor_nbiot_0.set_log(self.debug_log)
        self.hier_bs_nbiot_0.set_debug_log(self.debug_log)
...
def main(top_block_cls=demo_loop_nbiot, options=None):
    if options is None:
