...
class bs_multislot_dyn_ephyl_nbiot(gr.top_block):

    def __init__(self, M=32, N=1, T_bch=200, T_g=50, T_p=1000, T_s=150, cp_ratio=0.25, debug_log=False, ip_decision_layer_addr='localhost', list_sensor=["A","B"], lora_bw=250e3, lora_cr=4, lora_crc=True, lora_sf=7, port_bs_feedback=5562, port_bs_inst=5561, power_tresh=-30, sample_rate=1e6, sn_1_ip_addr='mnode4', sn_2_ip_addr='mnode5', S=1):
        ...
        def _variable_function_probe_0_probe():
            while True:
                val = self.hier_bs_nbiot_0.ephyl_bs_scheduler_0.set_top_block(self)
                try:
        ...
        # Connections
        ##################################################
        self.msg_connect((self.hier_bs_nbiot_0, 'BCH'), (self.zeromq_pub_msg_sink_0, 'in'))
        self.msg_connect((self.hier_bs_nbiot_0, 'DL'), (self.zeromq_pub_msg_sink_0, 'in'))
        self.msg_connect((self.hier_bs_nbiot_0, 'feedback'), (self.zeromq_pub_msg_sink_0_0, 'in'))
        self.msg_connect((self.hier_bs_nbiot_0, 'DLCCH'), (self.zeromq_pub_msg_sink_0_0_0, 'in'))
        self.msg_connect((self.zeromq_sub_msg_source_0_0, 'out'), (self.hier_bs_nbiot_0, 'inst'))
        self.msg_connect((self.zeromq_sub_msg_source_0_0_0, 'out'), (self.hier_bs_nbiot_0, 'ULCCH'))
        self.msg_connect((self.zeromq_sub_msg_source_0_0_0_0, 'out'), (self.hier_bs_nbiot_0, 'ULCCH'))
        self.connect((self.hier_bs_nbiot_0, 0), (self.blocks_null_sink_0, 0))
        self.connect((self.uhd_usrp_source_0_0, 0), (self.hier_bs_nbiot_0, 0))
    ...
    def set_power_tresh(self, power_tresh):
        self.power_tresh = power_tresh
        self.hier_bs_nbiot_0.set_power_tresh_detection(self.power_tresh)
